...
const ICON_STYLE = "inline size-4 ml-1.5 mb-1 fill-current";

export default function Footer() {
  return (
    <footer className="bg-hob-lightpink lg:h-24 flex items-center w-full relative font-semibold shadow-md">
